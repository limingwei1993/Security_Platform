 ...
 *   2) MALLOC_MEMPOOL - to be used by mem_malloc_EMAC in mem.c
...
#endif /* ip_frag_EMAC && !IP_FRAG_USES_STATIC_BUF && !LWIP_NETIF_TX_SINGLE_PBUF */
 ...
 */
LWIP_PBUF_MEMPOOL(PBUF,      MEMP_NUM_PBUF,            0,                             "pbuf_ref_EMAC/ROM")
